...
trait SchemaFixture {
  ...
  val provenanceSchemaUrl = "https://easy.dans.knaw.nl/schemas/bag/metadata/prov/provenance.xsd"
  ...
  lazy val triedProvenanceSchema: Try[Schema] = loadSchema(provenanceSchemaUrl)
